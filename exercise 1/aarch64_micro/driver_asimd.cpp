...
#pragma omp master
  ...
  ofstreamFile.open("peak_asimd_fmadd_sp_flops", std::ios::out | std::ios::app);
  ofstreamFile << l_g_flops << ",";
  ofstreamFile.close();
...
#pragma omp master
  ...
  ofstreamFile.open("peak_asimd_fmadd_dp_flops", std::ios::out | std::ios::app);
  ofstreamFile << l_g_flops << ",";
  ofstreamFile.close();
...
#pragma omp master
  ...
  ofstreamFile.open("peak_asimd_fmla_sp_flops", std::ios::out | std::ios::app);
  ofstreamFile << l_g_flops << ",";
  ofstreamFile.close();
...
#pragma omp master
  ...
  ofstreamFile.open("peak_asimd_fmla_dp_flops", std::ios::out | std::ios::app);
  ofstreamFile << l_g_flops << ",";
  ofstreamFile.close();
